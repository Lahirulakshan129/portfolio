...
export const Footer = ({ scrollTo, darkMode }: FooterProps) => {
  ...
  const socialLinks = [
    ...
    { 
      name: "LinkedIn", 
      icon: "linkedin", 
      url: "https://www.linkedin.com/in/lahiru-lakshan-b1b607201/",
      ...
      <div className="relative max-w-6xl mx-auto px-6 py-12">
          ...
          <div className="md:col-span-4">
            ...
            >
              ...
              <p className={`text-sm ${darkMode ? "text-gray-400" : "text-gray-500"}`}>
                © {currentYear} Lahiru Lakshan. Built with Passion & Creativity
              </p>
            </motion.div>
          </div>
              ...
              <nav className="space-y-2">
                {navigationLinks.map((link) => (
                  <button
                    ...
                    className={`block w-full text-left text-sm transition-all duration-300 rounded-lg px-3 py-2 ${
                      darkMode 
        ...
        >
          <p className={`text-xs ${darkMode ? "text-gray-500" : "text-gray-400"}`}>
            Crafted with care • Always learning • Forever improving
          </p>
          
          <Button
            onClick={() => scrollTo("home")}
            className={`group relative overflow-hidden px-6 py-3 rounded-full font-medium transition-all duration-300 shadow-lg ${
              darkMode
