...
// Badge Component
const Badge: React.FC<BadgeProps> = ({ children, icon: Icon, delay = 0, darkMode = false }) => {
...
// Card Component
const Card: React.FC<CardProps> = ({ title, subtitle, period, description, icon: Icon, links, delay = 0, darkMode = false }) => {
...
const ProfilePhoto: React.FC<{ darkMode?: boolean }> = ({ darkMode = false }) => {
...
const SocialLinks: React.FC<{ darkMode?: boolean }> = ({ darkMode = false }) => {
  ...
  const socials: SocialLink[] = [
    { icon: Github, href: "https://github.com", color: "hover:text-gray-700 dark:hover:text-white" },
    { icon: Linkedin, href: "https://linkedin.com", color: "hover:text-blue-600" },
    { icon: Mail, href: "mailto:hello@example.com", color: "hover:text-red-500" }
  ];
...
const About: React.FC<AboutProps> = ({ darkMode = false }) => {
  ...
  useGSAP(() => {
    ...
    if (photoSectionRef.current) {
      gsap.fromTo(photoSectionRef.current,
        {
          opacity: 0,
          x: 30
        },
  ...
  const experiences: Experience[] = [
    {
      ...
      period: '2022 - Present',
      description: 'Leading frontend development for enterprise applications with React and modern patterns.',
      icon: Briefcase,
      links: [
    ...
    },
    {
      ...
      icon: Code2,
      links: [
        { label: 'Projects', url: 'https://example.com' }
      ]
    }
  ];
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 lg:gap-8 items-start">
          ...
          <div className="space-y-4 lg:space-y-6">
            ...
            <section className="mb-6 lg:mb-8">
              ...
              >
                <p>
                  Full-stack developer with 4+ years of experience creating 
                  digital experiences that blend design with functionality.
                </p>
                <p>
          ...
          {/* Right Column - Photo */}
          <div ref={photoSectionRef} className="flex justify-center lg:justify-end">
